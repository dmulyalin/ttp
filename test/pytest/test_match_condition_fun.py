...
interface {{ interface | contains_re(var_1) }}
  ...
  {{ is_loopback| set(False) }}
    ...
    assert res == [[[{'description': 'Storage', 'interface': 'Port-Channel11', 'is_lag': True, 'is_loopback': False},
                     {'description': 'Management_2', 'interface': 'Port-Channel12', 'is_lag': True, 'is_loopback': False}]]]
...
interface {{ interface | notstartswith_re(r"Loop\\S+") }}
  ...
  {{ is_loopback| set(False) }}
    ...
    # pprint.pprint(res, width=150)
    assert res == [[[{'interface': 'Port-Channel11', 'is_lag': True, 'is_loopback': False},
                     {'description': 'Management', 'interface': 'Vlan777', 'is_lag': True, 'is_loopback': False}]]]
...
interface {{ interface | exclude_re(r"back.+") }}
  description {{ description }}
    ...
    res = parser.result()
    # pprint.pprint(res, width=150)
    assert res == [[[{'interface': 'Port-Channel11'}, {'description': 'Management', 'interface': 'Vlan777'}]]]
...
interface {{ interface | contains(Port) }}
  description {{ description }}
    ...
    res = parser.result()
    # pprint.pprint(res, width=150)
    assert res == [[[{'description': 'Storage', 'interface': 'Port-Channel11'}, {'description': 'Management', 'interface': 'Port-Channel12'}]]]
